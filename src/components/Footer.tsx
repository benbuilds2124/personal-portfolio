  ...
  return (
    <>
      <footer className="w-full max-w-5xl mx-auto border-t border-slate-200 dark:border-slate-800 pt-6 pb-4">
        <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-6">
          <div className="flex flex-col items-start gap-y-4 md:w-1/3">
            <div>
              <h2 className="text-2xl font-medium mb-1 tracking-tight">
                <span className="font-dancing-script font-bold text-3xl bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-emerald-500">Benajamin Liu</span>
              </h2>
              <div className="flex flex-col gap-y-1 mt-3">
                <p className="text-xs font-medium text-slate-800 dark:text-slate-200">Senior Frontend Engineer</p>
                <p className="text-[10px] text-slate-600 dark:text-slate-400">Amsterdam, Netherlands</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 sm:grid-cols-3 gap-6 text-left">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2 text-xs text-slate-600 dark:text-slate-400 font-medium">
                <a target="_blank" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="https://github.com/benbuilds2124">Github</a>
            ...
            <div className="flex flex-col gap-3 col-span-2 sm:col-span-1">
              ...
              <div className="flex items-center gap-2 mt-1">
                <a target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors" href="https://github.com/benbuilds2124">
                  <Github className="w-4 h-4" />
                </a>
                <a target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors" href="https://x.com/benbuilds2124">
                  <Twitter className="w-4 h-4" />
                </a>
                {/* email */}
                <a target="_blank" rel="noopener noreferrer" aria-label="Mail" className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 transition-colors" href="mailto:moonrider2124@gmail.com">
        ...
        <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-3 text-[11px] text-slate-600 dark:text-slate-400 font-medium">
          <span>© {year} Benjamin Liu. All rights reserved.</span>
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
            <p>Built with ❤️ by <a target="_blank" rel="noopener noreferrer" className="text-slate-800 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors underline underline-offset-2" href="https://www.linkedin.com/in/benbuilds2124/">Benjamin Liu</a></p>
          </div>
        </div>
      </footer>
    </>
